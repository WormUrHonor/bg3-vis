...
export const bg3Spells: BG3Spell[] = [
  ...
  spell("feather-fall", "Feather Fall", 1, { label: "9m", meters: 9, category: "mid", shape: "radius" }, ["defense-protection", "mobility-positioning"], [], ["bonus-action"]),
  ...
  spell("speak-with-dead", "Speak with Dead", 3, { label: "9m", meters: 9, category: "mid", shape: "single-target" }, ["narrative-interaction", "investigation-world-interaction"], [], ["action"]),
  invocation("invocation-speak-with-dead", "Invocation: Speak with Dead", 3, { label: "9m", meters: 9, category: "mid", shape: "single-target" }, ["narrative-interaction", "investigation-world-interaction"], [], ["action"]),
