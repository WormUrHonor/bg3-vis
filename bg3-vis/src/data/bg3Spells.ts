...
export const bg3Spells: BG3Spell[] = [
  ...
  spell("bane", "Bane", 1, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["control"], [], ["action"], true),
  invocation("invocation-bane", "Invocation: Bane", 1, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["control"], [], ["action"], true),
  spell("bless", "Bless", 1, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["support-buff"], [], ["action"], true),
  spell("burning-hands", "Burning Hands", 1, { label: "5m cone", meters: 5, category: "close", shape: "cone" }, ["area-damage"], ["Fire"], ["action"]),
  ...
  spell("colour-spray", "Colour Spray", 1, { label: "5m cone", meters: 5, category: "close", shape: "cone" }, ["control"], [], ["action"]),
  spell("command", "Command", 1, { label: "18m", meters: 18, category: "long", shape: "single-target" }, ["control"], [], ["action"]),
  spell("compelled-duel", "Compelled Duel", 1, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["control", "defense-protection"], [], ["bonus-action"], true),
  spell("create-or-destroy-water", "Create or Destroy Water", 1, { label: "4m", meters: 4, category: "close", shape: "radius" }, ["support-buff", "investigation-world-interaction"], [], ["action"]),
  ...
  spell("feather-fall", "Feather Fall", 1, { label: "9m", meters: 9, category: "close", shape: "radius" }, ["defense-protection", "mobility-positioning"], [], ["bonus-action"]),
  spell("find-familiar", "Find Familiar", 1, { label: "18m", meters: 18, category: "long", shape: "single-target" }, ["summon", "investigation-world-interaction"], [], ["action"]),
  spell("find-familiar-imp", "Find Familiar: Imp", 1, { label: "18m", meters: 18, category: "long", shape: "single-target" }, ["summon"], [], ["action"]),
  spell("find-familiar-quasit", "Find Familiar: Quasit", 1, { label: "18m", meters: 18, category: "long", shape: "single-target" }, ["summon"], [], ["action"]),
  spell("find-familiar-cheeky-quasit", "Find Familiar: Cheeky Quasit", 1, { label: "18m", meters: 18, category: "long", shape: "single-target" }, ["summon"], [], ["action"]),
  ...
  spell("thunderwave", "Thunderwave", 1, { label: "1.5m, 5m AoE", meters: 5, category: "close", shape: "radius", aoeMeters: 5 }, ["area-damage", "control"], ["Thunder"], ["action"]),
  ...
  spell("aid", "Aid", 2, { label: "self, 9m", meters: 9, category: "close", shape: "radius" }, ["support-buff", "healing"], [], ["action"]),
  ...
  spell("darkness", "Darkness", 2, { label: "5m", meters: 5, category: "close", shape: "radius" }, ["control", "defense-protection"], [], ["action"], true),
  ...
  spell("enlarge-reduce", "Enlarge/Reduce", 2, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["support-buff", "control"], [], ["action"], true),
  spell("enthrall", "Enthrall", 2, { label: "6m", meters: 6, category: "close", shape: "single-target" }, ["control"], [], ["action"]),
  ...
  spell("pass-without-trace", "Pass Without Trace", 2, { label: "9m", meters: 9, category: "close", shape: "radius" }, ["support-buff", "mobility-positioning"], [], ["action"], true),
  ...
  spell("prayer-of-healing", "Prayer of Healing", 2, { label: "9m", meters: 9, category: "close", shape: "radius" }, ["healing"], [], ["action"]),
  ...
  spell("see-invisibility", "See Invisibility", 2, { label: "9m", meters: 9, category: "close", shape: "radius" }, ["investigation-world-interaction", "support-buff"], [], ["action"]),
  spell("shatter", "Shatter", 2, { label: "18m, 3m AoE", meters: 18, category: "long", shape: "radius", aoeMeters: 3 }, ["area-damage"], ["Thunder"], ["action"]),
  spell("silence", "Silence", 2, { label: "18m, 6m AoE", meters: 18, category: "long", shape: "radius", aoeMeters: 6 }, ["control", "defense-protection"], [], ["action"], true),
  invocation("invocation-silence", "Invocation: Silence", 2, { label: "18m, 6m AoE", meters: 18, category: "long", shape: "radius", aoeMeters: 6 }, ["control", "defense-protection"], [], ["action"], true),
  ...
  spell("beacon-of-hope", "Beacon of Hope", 3, { label: "9m", meters: 9, category: "close", shape: "radius" }, ["support-buff", "healing"], [], ["action"], true),
  ...
  spell("conjure-barrage", "Conjure Barrage", 3, { label: "9m", meters: 9, category: "close", shape: "cone" }, ["area-damage"], ["Weapon"], ["action"]),
  ...
  spell("crusaders-mantle", "Crusader's Mantle", 3, { label: "9m", meters: 9, category: "close", shape: "radius" }, ["support-buff", "single-target-damage"], ["Radiant"], ["action"], true),
  ...
  spell("fear", "Fear", 3, { label: "9m", meters: 9, category: "close", shape: "cone" }, ["control"], [], ["action"], true),
  ...
  spell("glyph-of-warding", "Glyph of Warding", 3, { label: "9m, 4m AoE", meters: 9, category: "close", shape: "radius", aoeMeters: 4 }, ["area-damage", "control"], ["Thunder", "Lightning", "Fire", "Cold", "Acid"], ["action"]),
  spell("grant-flight", "Grant Flight", 3, touch, ["mobility-positioning"], [], ["action"], true),
  spell("haste", "Haste", 3, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["support-buff", "mobility-positioning", "defense-protection"], [], ["action"], true),
  ...
  spell("revivify", "Revivify", 3, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["healing", "support-buff"], [], ["action"]),
  ...
  spell("speak-with-dead", "Speak with Dead", 3, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["narrative-interaction", "investigation-world-interaction"], [], ["action"]),
  invocation("invocation-speak-with-dead", "Invocation: Speak with Dead", 3, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["narrative-interaction", "investigation-world-interaction"], [], ["action"]),
  ...
  spell("blight", "Blight", 4, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["single-target-damage"], ["Necrotic"], ["action"]),
  ...
  spell("guardian-of-faith", "Guardian of Faith", 4, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["summon", "single-target-damage"], ["Radiant"], ["action"]),
  ...
  spell("otilukes-resilient-sphere", "Otiluke's Resilient Sphere", 4, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["defense-protection", "control"], [], ["action"], true),
  ...
  spell("cone-of-cold", "Cone of Cold", 5, { label: "9m cone", meters: 9, category: "close", shape: "cone" }, ["area-damage"], ["Cold"], ["action"]),
  ...
  spell("destructive-wave", "Destructive Wave", 5, { label: "6m", meters: 6, category: "close", shape: "radius", aoeMeters: 6 }, ["area-damage", "control"], ["Thunder", "Radiant", "Necrotic"], ["action"]),
  ...
  spell("grasping-vine", "Grasping Vine", 5, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["summon", "control"], [], ["bonus-action"]),
  ...
  spell("disintegrate", "Disintegrate", 6, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["single-target-damage"], ["Force"], ["action"]),
  ...
  spell("ottos-irresistible-dance", "Otto's Irresistible Dance", 6, { label: "9m", meters: 9, category: "close", shape: "single-target" }, ["control"], [], ["action"], true),
  ...
  spell("wind-walk", "Wind Walk", 6, { label: "9m", meters: 9, category: "close", shape: "radius" }, ["mobility-positioning", "defense-protection"], [], ["action"], true),
];
