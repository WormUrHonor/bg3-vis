...
export const spellChoiceRuleDefinitions: SpellChoiceRuleDefinition[] = [
  {
  id: "cleric-cantrips",
  label: "Cleric Cantrips",
  className: "Cleric",
  minLevel: 1,
  ranks: [0],
  spellIds: CLERIC_CANTRIP_IDS,
  maxByLevel: [
    { minLevel: 1, max: 3 },
    { minLevel: 4, max: 4 },
    { minLevel: 10, max: 5 },
  ],
  displayGroupLabel: "Cleric Cantrip Choices",
  displayGroupOrder: 10,
},

{
  id: "cleric-prepared-spells",
  label: "Cleric Prepared Spells",
  className: "Cleric",
  minLevel: 1,
  ranks: [1, 2, 3, 4, 5, 6],
  spellIds: CLERIC_SPELL_IDS,
  maxByLevel: [
    { minLevel: 1, max: 4 },
    { minLevel: 2, max: 5 },
    { minLevel: 3, max: 6 },
  ...
  displayGroupLabel: "Cleric Prepared Spells",
  ...
  minLevel: 1,
  ranks: [0],
  spellIds: WIZARD_CANTRIP_IDS,
  maxByLevel: [
    { minLevel: 1, max: 3 },
    { minLevel: 4, max: 4 },
    { minLevel: 10, max: 5 },
  ],
  displayGroupLabel: "Wizard Cantrip Choices",
  displayGroupOrder: 10,
},

{
  id: "wizard-learned-spells",
  label: "Wizard Spells Learned",
  className: "Wizard",
  minLevel: 1,
  ranks: [1, 2, 3, 4, 5, 6],
  spellIds: WIZARD_SPELL_IDS,
  maxByLevel: [
    { minLevel: 1, max: 6 },
    { minLevel: 2, max: 8 },
    { minLevel: 3, max: 10 },
  ...
  displayGroupLabel: "Wizard Spellbook Choices",
  displayGroupOrder: 20,
},
  {
